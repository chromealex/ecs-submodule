...
namespace ME.ECS {
    ...
    public readonly struct Entity : System.IEquatable<Entity>, System.IComparable<Entity> {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        #endif
        public bool IsAlive(in ME.ECS.Collections.LowLevel.Unsafe.MemoryAllocator allocator, in ME.ECS.FiltersArchetype.FiltersArchetypeStorage storage) {

            // Inline manually
            return this.generation > 0 && storage.cache[in allocator, this.id].generation == this.generation;
