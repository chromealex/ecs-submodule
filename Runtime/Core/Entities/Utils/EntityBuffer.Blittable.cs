...
namespace ME.ECS {
    ...
    public static class DataUnmanagedDisposableBufferUtils {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static bool PushRemove_INTERNAL<T>(World world, in Entity entity, StructComponentsUnmanaged<T> reg, StorageType storageType = StorageType.Default) where T : struct, IComponentDisposable {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static bool PushSet_INTERNAL<T>(World world, in Entity entity, StructComponentsUnmanaged<T> reg, in T data, StorageType storageType = StorageType.Default) where T : struct, IComponentDisposable {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static bool PushRemove_INTERNAL<T>(World world, in Entity entity, ref ME.ECS.Collections.V3.MemoryAllocator allocator, ref UnmanagedComponentsStorage.ItemDisposable<T> reg) where T : struct, IComponentDisposable {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static void PushSet_INTERNAL<T>(World world, in Entity entity, ref ME.ECS.Collections.V3.MemoryAllocator allocator, ref UnmanagedComponentsStorage.ItemDisposable<T> reg, in T data) where T : struct, IComponentDisposable {
