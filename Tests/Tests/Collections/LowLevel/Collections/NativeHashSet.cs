namespace ME.ECS.Tests.LowLevel.Collections {
    ...
    public class NativeHashSet {
        ...
        public struct Test : IEquatableAllocator<Test> {
            ...
            public bool Equals(in ME.ECS.Collections.LowLevel.Unsafe.MemoryAllocator allocator, Test obj) {
                return this.x == obj.x &&
                    this.y == obj.y &&
                    this.z == obj.z;
            }

            public int GetHash(in ME.ECS.Collections.LowLevel.Unsafe.MemoryAllocator allocator) {
