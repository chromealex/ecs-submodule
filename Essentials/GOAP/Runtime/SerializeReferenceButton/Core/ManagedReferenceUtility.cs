...
namespace ME.ECS.Essentials.GOAP {
    ...
    public static class ManagedReferenceUtility {
        ...
        public static Type GetManagedReferenceFieldType(this SerializedProperty property) {
            ...
            if (realPropertyType != null) return realPropertyType;

            UnityEngine.Debug.LogError($"Can not get field type of managed reference : {property.managedReferenceFieldTypename}");
            return null;
        }

        /// Gets real type of managed reference
        public static Type GetManagedReferenceType(this SerializedProperty property) {
            var realPropertyType = GetRealTypeFromTypename(property.managedReferenceFullTypename);
            if (realPropertyType != null) return realPropertyType;
