...
namespace ME.ECS.Essentials.GOAP {
    ...
    public readonly struct GOAPGroupId : IComparable, IConvertible, IFormattable, IComparable<TName>, IEquatable<TName>, ISerializable {

        public const TType Zero = (TType)0;

        public readonly TType v; // Do not rename (binary serialization)

        private GOAPGroupId(TType value) {

            this.v = value;

        }

        private GOAPGroupId(SerializationInfo info, StreamingContext context) {
