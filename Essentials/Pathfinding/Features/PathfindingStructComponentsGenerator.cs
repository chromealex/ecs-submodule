...
namespace ME.ECS {
    ...
    public static class PathfindingComponentsInitializer {
        ...
        public static void Init(ref ME.ECS.StructComponentsContainer structComponentsContainer) {
            ...
            WorldUtilities.InitComponentTypeId<ME.ECS.Pathfinding.Features.Pathfinding.Components.CalculatePath>(false, false, true, false);
            ...
            WorldUtilities.InitComponentTypeId<ME.ECS.Pathfinding.Features.Pathfinding.Components.IsPathfinding>(true, false, true, false);
            WorldUtilities.InitComponentTypeId<ME.ECS.Pathfinding.Features.Pathfinding.Components.BuildAllGraphs>(true, false, true, false);
            WorldUtilities.InitComponentTypeId<ME.ECS.Pathfinding.Features.Pathfinding.Components.IsAllGraphsBuilt>(true, false, true, false);
            WorldUtilities.InitComponentTypeId<ME.ECS.Pathfinding.Features.Pathfinding.Components.HasPathfindingInstance>(true, false, true, false);
            WorldUtilities.InitComponentTypeId<ME.ECS.Pathfinding.Features.Pathfinding.Components.IsPathBuilt>(true, false, true, false);
