...
namespace ME.ECSEditor {
    ...
    public class StructComponentsGenerator : Generator {
        ...
        private const string CONTENT_ITEM = @"
            #CONTAINER#.Validate#BLITTABLE##COPYABLE##DISPOSABLE##ONESHOT##TAG#<#TYPENAME#>(#ISTAG#);";
        private const string CONTENT_ITEM2 = @"
            entity.ValidateData#BLITTABLE##COPYABLE##DISPOSABLE##ONESHOT##TAG#<#TYPENAME#>(#ISTAG#);";
