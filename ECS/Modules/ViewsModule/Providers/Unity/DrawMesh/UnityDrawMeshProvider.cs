...
namespace ME.ECS.Views.Providers {
    ...
    public abstract class DrawMeshViewBase : IPoolableRecycle {
        ...
        public void SetItems(UnityEngine.Vector3 rootPosition, UnityEngine.Vector3 rootRotation, UnityEngine.Vector3 rootScale, UnityEngine.MeshFilter[] filters,
            ...
            for (int i = 0; i < filters.Length; ++i) {
                ...
                itemData.localScale =
                    (i == 0 ? rootScale : UnityEngine.Vector3.Scale(tr.lossyScale, new UnityEngine.Vector3(1f / rootScale.x, 1f / rootScale.y, 1f / rootScale.z)));
